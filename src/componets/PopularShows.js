...
import { popular } from '../datalists/data'
                    ...
                    return (
                        <div key={id} className='card max-md:my-6 h-96 w-80 relative rounded-md text-white'>
                            <div className='card_image h-2/3 w-full rounded-md'>
                                <img src={image} alt='' className='h-full w-full rounded-md object-contain' />
                            </div>
                            <p className=' py-10 px-2 text-3xl text-center'>{title}</p>
                        </div>
                    )
                })}
            </div>
